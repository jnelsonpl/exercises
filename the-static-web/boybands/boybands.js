/*
Instructions:
Loop through the two arrays provided (bands and vegetables) and 
...
for (var loopTracker = 0; loopTracker < loopCount; loopTracker += 1) {
  ...
  bandElement.innerHTML += "<p style=color:red;>" + currentBand + "</p>";

  // Add the veggie names into the correct <div>
  currentVeggie = vegetables[loopTracker];
  veggieElement.innerHTML += "<p style=color:blue;>" + currentVeggie + "</p>";
